...
// GetBody read body
func GetBody(client *http.Client, URL string, RCPC string) ([]byte, error) {
	req, err := http.NewRequest("GET", URL, nil)
	req.AddCookie(&http.Cookie{Name: "RCPC", Value: RCPC})
...
func PostBody(client *http.Client, URL string, data url.Values, RCPC string) ([]byte, error) {
